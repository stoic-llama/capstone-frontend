            ...
            <form @submit.prevent="toggleLike()">
                <div @mouseover="showBubble = true" @mouseleave="showBubble = false">
                    <button 
                        ...
                        :class="{ 'disabled-button': hasLiked }" 
                        :disabled="hasLiked"
                    >
            ...
            <form @submit.prevent="toggleDislike()">
                <div @mouseover="showBubble = true" @mouseleave="showBubble = false">
                    <button 
                        ...
                        :class="{ 'disabled-button': hasDisliked }" 
...
export default {
    ...
    computed: {
        ...
        hasLiked() {
            return this.likesArray.includes(this.email);
        },
        hasDisliked() {
            return this.dislikesArray.includes(this.email);
        },
    },
    data() {
        return {
